...
<div class="content-wrapper"  style="margin-left: 0px !important;">
			...
			<div class="content-header" style="padding-bottom: 0px !important;">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-dark"><i class="fas fa-align-justify"></i> Other</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <!-- <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li> -->
        		        <li class="breadcrumb-item active">Undetected Type Injections Logs</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
...
$sql   = $connection->query("SELECT id, date, time, http_url, http_method, description FROM `$table` WHERE type='dom'");
