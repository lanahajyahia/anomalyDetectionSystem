...
<div>
    ...
    <p class="findaccounttext"> Type in your email address below and we'll send you an email with instructions on how to create new password </p>
		...
		<div class="input-group sendcancel">
            <button style="background-color: #e4e6eb; color: #4b4f56; margin-right:0.5em" type="submit" class="btn" name="login_btn">Cancel</button>

			<button type="submit" class="btn" name="login_btn">Send</button>
